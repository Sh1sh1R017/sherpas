  ...
  try {
    ...
    const prompt = `
      ...
      Requested JSON Schema:
      {
        ...
        "leadScore": Number from 0-100 (Award higher scores if the website shows evidence of active social media presence, active marketing, or running ads, as this indicates they have budget and need scalable systems),
